...
Feature: Using Android test Mobile Data Connections FUNC NDS HTTP CAT check 
  ...
  Scenario Outline: Using Android device check mobile apn "<apnname>"  by visting UK site "<title>".
    ...
    Examples: 
| apnname                  | url                      | title |
|idata-func-epg1           | http://www.xhaus.com/headers | xhaus |
...
|idata-func-epg1-same-again| http://201.incompass.netstar-inc.com | 18 |
|idata-func-epg1-same-again| http://203.incompass.netstar-inc.com | 18 |
|idata-func-epg1-same-again| http://204.incompass.netstar-inc.com | 18 |
|idata-func-epg1-same-again| http://301.incompass.netstar-inc.com | 18 |
|idata-func-epg1-same-again| http://303.incompass.netstar-inc.com | 18 |
|idata-func-epg1-same-again| http://304.incompass.netstar-inc.com | 18 |
