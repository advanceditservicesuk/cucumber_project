...
| idata-func-epg1-same-apn| http://translate.google.com |Parental| 
| idata-func-epg1-same-apn| http://match.com |Parental| 
| idata-func-epg1-same-apn| http://mtnmatchmaking.com |Parental| 
| idata-func-epg1-same-apn| http://finance.yahoo.com |Parental| 
...
| idata-func-epg1-same-apn| http://www.amazon.com |Parental| 
...
| idata-func-epg1-same-apn| http://gmail.com |Parental| 
...
| idata-func-epg1-same-apn| http://dropbox.com |Parental| 
...
| idata-func-epg1-same-apn| http://allcanadacontests.com |Parental| 
| idata-func-epg1-same-apn| http://automotive.com |Parental| 
| idata-func-epg1-same-apn| http://accenture.com |Parental| 
| idata-func-epg1-same-apn| http://microsoft.com |Parental| 
...
| idata-func-epg1-same-apn| http://wikipedia.org |Parental| 
| idata-func-epg1-same-apn| http://google.com |Parental| 
...
| idata-func-epg1-same-apn| http://cloudflare.com |Parental| 
...
| idata-func-epg1-same-apn| http://aghepodlln |Parental| 
...
| idata-func-epg1-same-apn| http://192.168.1.1 |Parental| 
...
| idata-func-epg1-same-apn| http://www.khanacademy.org/ |Parental| 
| idata-func-epg1-same-apn| http://www.swarmapp.com |Parental| 
| idata-func-epg1-same-apn| http://www.facebook.com |Parental| 
| idata-func-epg1-same-apn| http://www.linkedin.com |Parental| 
| idata-func-epg1-same-apn| http://www.twitter.com |Parental| 
| idata-func-epg1-same-apn| http://www.youtube.com |Parental| 
| idata-func-epg1-same-apn| http://www.instagram.com |Parental| 
| idata-func-epg1-same-apn| http://www.tumblr.com |Parental| 
| idata-func-epg1-same-apn| http://plus.google.com |Parental| 
...
| idata-func-epg1-same-apn| http://www.wordpress.com |Parental| 
