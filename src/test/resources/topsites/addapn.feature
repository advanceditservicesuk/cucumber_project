...
Feature: Using Android device add list of apn to the device
  ...
  Scenario Outline: Using Android device add list of apn to the device
    Given Using Android device and serialno "8a936b38" add new apn using following values "<apnname>","<apn>","<username>","<password>","<mmsc>","<mmsc_proxy>","<mms_port>","<proxy>" and "<port>"
